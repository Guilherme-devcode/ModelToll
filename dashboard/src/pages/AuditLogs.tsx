...
import { Search, Filter, ChevronLeft, ChevronRight, Shield, Ban, ArrowRight } from 'lucide-react'
  ...
  const { data, loading, error, refetch } = useApi(
    () =>
      DEMO
        ...
        : api.logs({ page, page_size: 50, action: actionFilter || undefined, scrubbed_only: scrubbedOnly }),
    [page, actionFilter, scrubbedOnly]
  )
